...
const config = {
    serverInfo: {
        ...
        serverName: "Golden Network", /*Server name*/
        serverIp: "gz.feathermc.gg", /*Server IP (if you want to add online user counter, you must have true the enable-status and enable-query of server.properties)*/
        discordServerID: "1279266584195760251" /*Your server ID (if you want to add online user counter, you must have enabled Discord server widget)*/
    },
    ...
    */
    ...
    adminTeamPage: {
        leaders: [
            ...
            {
                inGameName: "GodbenderYt",
                rank: "CoOwner",
                skinUrlOrPathToFile: "",
                rankColor: "rgba(255, 3, 3, 1)"
            },
            {
                inGameName: "sologamer5674",
                rank: "Admin",
                skinUrlOrPathToFile: "",
                rankColor: ""
            },
            {
                inGameName: "Maroon_Gamer",
                rank: "Admin",
                skinUrlOrPathToFile: "",
                rankColor: ""
            },
